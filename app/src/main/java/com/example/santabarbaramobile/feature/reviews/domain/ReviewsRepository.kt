...
class ReviewsRepository @Inject constructor(
    ...
    suspend fun getReviewsByShow(tvmazeId: Int, page: Int = 1): Result<ReviewPaginationResponse> =
    ...
    suspend fun createReview(
        ...
        try {
            ...
            val response =
                api.createReview(token, rbTvmazeId, rbRating, rbTitle, rbContent, imagePart)
